...
load_model(controlnet_instantid,'/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_casia_depth_efu4_epoch100/model_controlnet.safetensors')
load_model(unet_ipadapter,'/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_casia_depth_efu4_epoch100/model_unet.safetensors')
...
vit_image_embeddings_model = "/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/id_emb_vit/casia_vit_output_newtrainset_efu4fu5/checkpoint-300"
...
def test_controlnetforpolyuiris(test_vis_dir,test_nir_dir,test_vis_canny_dir,test_vis_mask_dir,save_resulted_nir_dir,save_grid_result_dir):
    ...
    for vis,nir,vis_canny,vis_mask in tqdm(zip(vis_imgs,nir_imgs,vis_cannys,vis_masks)):
        ...
        if int(id_label) < 61:
            id_label = str(int(id_label)).zfill(3)
        elif int(id_label) >= 61 and int(id_label) < 74:
            id_label = str(int(id_label) - 1).zfill(3)
        else:
            id_label = str(int(id_label) - 2).zfill(3)
        ...
        vis_img_show = vis_img.resize((256,256),resample=Image.LANCZOS)

        nir_img = load_image(os.path.join(test_nir_dir,nir))
        nir_img_show = nir_img.resize((256,256),resample=Image.LANCZOS)
...
if __name__=='__main__':
    test_vis_dir ='/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/CASIA_NIR_VIS/test_200/VIS'
    test_nir_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/CASIA_NIR_VIS/test_200/NIR'
    test_vis_canny_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/CASIA_NIR_VIS/test_200/VIS_depth'
    test_vis_mask_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/CASIA_NIR_VIS/test_200/VIS_mask'
    save_resulted_nir_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_casia_depth_efu4_epoch200_0118/test_reuslt_epoch4000/nir_generated'
    save_grid_result_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_casia_depth_efu4_epoch200_0118/test_reuslt_epoch4000/comparative_result'
