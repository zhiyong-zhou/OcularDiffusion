...
# load_model(controlnet_instantid,'/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth_0626/checkpoint-42000/model.safetensors')
load_model(controlnet_instantid,'/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth/checkpoint-28000/model.safetensors')

# load_model(unet_ipadapter,'/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth_0626/checkpoint-42000/model_1.safetensors')
load_model(unet_ipadapter,'/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth/checkpoint-28000/model_1.safetensors')
...
vit_image_embeddings_model = "/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/id_emb_vit/polyuiris_vit_output/checkpoint-480"
...
def test_controlnetforpolyuiris(test_vis_dir,test_nir_dir,test_vis_canny_dir,test_vis_mask_dir,save_resulted_nir_dir,save_grid_result_dir):
    ...
    nir_imgs = sorted(os.listdir(test_nir_dir))
...
if __name__=='__main__':
    test_vis_dir ='/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/polyuiris_ieeetifs/train/vis'
    test_nir_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/polyuiris_ieeetifs/train/nir'
    test_vis_canny_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/polyuiris_ieeetifs/train/vis_depth'
    test_vis_mask_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/dataset/polyuiris_ieeetifs/train/vis_mask'
    # save_resulted_nir_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth_0626/trainset_resulted/nir_generated'
    # save_grid_result_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth_0626/trainset_resulted/comparative_grid'
    save_resulted_nir_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth/trainset_resulted/nir_generated'
    save_grid_result_dir = '/zhouzhiyong/ns219x/projects/diffusers/examples/controlnet/instantid_vis2nir_polyu_train60_lr1efu4_depth/trainset_resulted/comparative_grid'
